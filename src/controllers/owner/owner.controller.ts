...
import {
	CreateOwnerAlreadyExistsError,
	CreateOwnerBadRequestError
} from '../../usesCases/owner/createOwner/createOwnerErrors';
...
import {
	UpdateOwnerBadRequestError,
	UpdateOwnerNotFoundError
} from '../../usesCases/owner/updateOwner/updateOwnerErrors';
...
export class OwnerController {
	...
	async createOwner(req: Request, res: Response) {
		const { name, middleName, lastName, secondLastName, documentType, documentNumber, phoneNumber, email } =
			req.body as CreateOwnerRequestDto;
	...
	async updateOwner(req: Request, res: Response) {
		const { id } = req.params;
		const { name, middleName, lastName, secondLastName, documentType, documentNumber, phoneNumber, email } =
			req.body as UpdateOwnerRequestDto;
